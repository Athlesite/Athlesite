 ...
 *
 * The composition is restored to the original approved structure; only the
 * device rendering itself has been upgraded to feel more physically real.
 */
  ...
  return (
    <div className="s01-stage pointer-events-none absolute bottom-[72px] right-0 select-none">
      <div className="s01-stage-inner">
        ...
        {/* Device — same composition position, upgraded realistic hardware frame */}
        <div
          className="absolute"
          style={{
            left: S01_PHONE.left,
            top: S01_PHONE.top,
            transform: "perspective(1500px) rotateY(-2.5deg) rotateZ(0.35deg)",
