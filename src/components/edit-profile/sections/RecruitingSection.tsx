...
export function RecruitingSection({ profile, onChange }: RecruitingSectionProps) {
  return (
    <Section className="py-10 border-t border-border">
      <Container className="max-w-2xl">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Recruiting</h2>
